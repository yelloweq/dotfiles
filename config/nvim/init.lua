...
vim.opt.colorcolumn = ""                          -- do not show a color column
...
vim.keymap.set("n", "<leader>fm", "<CMD>Oil<CR>", { desc = "Toggle Oil" })
...
require("blink.cmp").setup({
    ...
    sources = {
        ...
        providers = {
            ...
            path = { name = "[Path]", score_offset = 90 },
            snippets = { name = "[Snip]", score_offset = 80 },
            buffer = { name = "[Buf]", score_offset = 50 },
            ['blade-nav'] = { 
                name = "[Blade]",
                score_offset = 40,
...
vim.lsp.config("intelephense", {
    ...
    init_options = {
        licenceKey = vim.env.INTELEPHENSE_LICENCE_PATH
            or (vim.fn.expand("~/.config/intelephense/licence.txt")),
    },
})
